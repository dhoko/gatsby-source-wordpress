...
const buildSelectionSet = (fields, {
  ...
  const buildFieldSelectionSet = field => {
    ...
    if ((!variables || variables === ``) && fields !== null && fields !== void 0 && fields.find(field => field.fieldName === `nodes`)) {
  ...
  if (transformedInlineFragments !== null && transformedInlineFragments !== void 0 && transformedInlineFragments.length) {
