...
function transformField({
  ...
  if (fieldType.kind === `SCALAR` || fieldType.kind === `ENUM` || fieldType.kind === `NON_NULL` && ofType.kind === `SCALAR` || fieldType.kind === `LIST` && fieldType.ofType.kind === `SCALAR` || field.type.kind === `LIST` && ((_field$type = field.type) === null || _field$type === void 0 ? void 0 : (_field$type$ofType = _field$type.ofType) === null || _field$type$ofType === void 0 ? void 0 : _field$type$ofType.kind) === `ENUM`) {
    return {
      fieldName,
      fieldType
    };
  ...
  if (fieldType.kind === `LIST` && isListOfGatsbyNodes && !isListOfMediaItems && hasIdField) {
    ...
    if (!(transformedFields !== null && transformedFields !== void 0 && transformedFields.length) && !(transformedInlineFragments !== null && transformedInlineFragments !== void 0 && transformedInlineFragments.length)) {
      return false;
  ...
  gatsbyNodesInfo.typeNames.includes(typeName) || ( // or all possible types on this type are Gatsby node types
  (_typeMap$get = typeMap.get(typeName)) === null || _typeMap$get === void 0 ? void 0 : (_typeMap$get$possible = _typeMap$get.possibleTypes) === null || _typeMap$get$possible === void 0 ? void 0 : _typeMap$get$possible.every(possibleType => gatsbyNodesInfo.typeNames.includes(possibleType.name)));
  ...
  if (fields || transformedInlineFragments) {
    ...
    if (!(transformedFields !== null && transformedFields !== void 0 && transformedFields.length) && !((_transformedInlineFra = transformedInlineFragments) !== null && _transformedInlineFra !== void 0 && _transformedInlineFra.length)) {
      return false;
    }
...
const createFragment = ({
  ...
  const fragmentFields = fields.reduce((fragmentFields, field) => {
    ...
    fieldType.name !== typeName && fieldType !== null && fieldType !== void 0 && (_fieldType$fields2 = fieldType.fields) !== null && _fieldType$fields2 !== void 0 && _fieldType$fields2.find(innerFieldField => (0, _helpers.findTypeName)(innerFieldField.type) === typeName)) {
  ...
  const transformedInlineFragments = queryType !== null && queryType !== void 0 && (_queryType$possibleTy = queryType.possibleTypes) !== null && _queryType$possibleTy !== void 0 && _queryType$possibleTy.length ? transformInlineFragments({
...
const transformFields = ({
  ...
  if (fragment && transformedField && buildingFragment !== typeName) {
    ...
    if (transformedField !== null && transformedField !== void 0 && (_transformedField$fie = transformedField.fields) !== null && _transformedField$fie !== void 0 && _transformedField$fie.length) {
    ...
    if (transformedField !== null && transformedField !== void 0 && (_transformedField$inl = transformedField.inlineFragments) !== null && _transformedField$inl !== void 0 && _transformedField$inl.length) {
